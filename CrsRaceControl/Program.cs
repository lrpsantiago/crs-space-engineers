...
namespace IngameScript
{
    partial class Program : MyGridProgram
    {
        ...
        private readonly string WEATHER_LCD_NAME = "Weather LCD";
        ...
        private IMyTextPanel _lcdWeather;
        ...
        private void UpdateMainLcd()
        {
            ...
            var text = _stringBuilder.Replace(';', ' ').ToString();

            if (_raceMode == RaceMode.Race)
            {
                _rankTable = text;
            }

            _lcdMain.WriteText(text);
        }
        ...
        private void SendData()
        {
            foreach (var key in _racers.Keys)
            {
                ...
                var strPosition = _raceMode == RaceMode.Race ? racer.Position : racer.FastestLapPosition;
                ...
                var data = $"{racer.Laps};{strPosition};{strCurrentLapTime};{strBestLapTime};{strTotalRacers};{strTotalLaps};{strCurrentFlag};{strCurrentWeather};{strRankTable};{strS1};{strS2};{strS3};{strPrevLapTime}";
        ...
        private void UpdateFastestLapsLcd()
        {
            ...
            var racers = _racers.Values
                .Where(r => r.BestLap != null && r.BestLap.IsFinished)
            ...
            {
                var position = i + 1;
                racers[i].FastestLapPosition = position;
        ...
        private void UpdateWeather()
        {
            ...
            if (_lcdWeather != null && !_lcdWeather.Closed)
            {
                _lcdWeather.WriteText(_weather.Description);
            }
        }
        ...
        private void SetupLcds()
        {
            ...
            if (_lcdSpeedtrap != null)
            {
                _lcdSpeedtrap.ContentType = ContentType.TEXT_AND_IMAGE;
            }

            _lcdWeather = (IMyTextPanel)GridTerminalSystem.GetBlockWithName(WEATHER_LCD_NAME);

            if (_lcdWeather != null)
            {
                _lcdWeather.ContentType = ContentType.TEXT_AND_IMAGE;
            }
