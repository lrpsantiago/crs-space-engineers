    ...
    partial class Program : MyGridProgram
    {
        ...
        private void UpdateDisplays()
        {
            ...
            foreach (var d in _displays)
            {
                ...
                var height = totalHeight * (_currentTyres.WearPercentage / 100);
                ...
                var percText = MySprite.CreateText($"{Math.Floor(_currentTyres.WearPercentage)}%", "DEBUG", Color.White, textScale);
        ...
        private void LoadState()
        {
            ...
            switch (compoundChar)
            {
                case 'U': SetTyres(TyreCompound.Ultra); break;
                case 'S': SetTyres(TyreCompound.Soft); break;
                case 'M': SetTyres(TyreCompound.Medium); break;
                case 'H': SetTyres(TyreCompound.Hard); break;
                case 'X': SetTyres(TyreCompound.Extra); break;
                case 'I': SetTyres(TyreCompound.Intermediate); break;
                case 'W': SetTyres(TyreCompound.Wet); break;
                default: SetTyres(TyreCompound.Soft); break;
            }

            _currentTyres.CurrentFriction = friction;
            _ersCharge = charge;
        }
        ...
        private void SaveState(bool force = false)
        {
            ...
            Me.CustomData = $"{tyreChar};{_currentTyres.CurrentFriction};{_ersCharge}";
